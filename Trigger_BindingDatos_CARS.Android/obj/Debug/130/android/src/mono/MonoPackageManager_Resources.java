...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Trigger_BindingDatos_CARS.Android.dll" comes first in this list. */
		"Trigger_BindingDatos_CARS.Android.dll",
		"FormsViewGroup.dll",
		"Trigger_BindingDatos_CARS.dll",
